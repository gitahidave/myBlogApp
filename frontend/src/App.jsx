  ...
  useEffect(() => {
    const checkCookie = async () => {
      ...
      try {
        ...
        if (response.data?.success || response.data?.message === true) {
          // Pass user data payload if provided by backend
          dispatch(authActions.login(response.data?.user || null));
        } else {
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/* Alternate Layout for Auth & Admin */}
